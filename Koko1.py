...
\033[1;94mAuthor    \033[1;91m: \033[1;91KOKO JANI
...
jalan("\033[1;93m тШЮ тФИтФИтФИтФИтФИтФИтФИтФИWhatsApp Num :  KOKOOFFICIAL 😝тФИтФИтФИтФИтФИтФИтФИтФИтФИтФИтФИ")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #KOKOJANI
...
def pilih_super():
	...
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By koko-jani--тАвтЧИтАв---┬╗" #Dev: Koko jani
...
: \033[1;93m.balochhacker  Koko jani... \033[1;93m :
